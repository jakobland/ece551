module nonoverlap_test();
	...
	//////////////////////////////////////
  logic clk;
	logic rst_n;				// global reset to all other blocks, produced by rst_synch
	logic start_seq;			// from PB_release unit, start stimulus to DUT
	logic highIn, lowIn;		// inputs to DUT generated by stim
    logic highOut,lowOut;	// outputs of DUT monitored by observer
  ...
  initial begin
    ...
    start_seq = 0;
    @(negedge clk) rst_n = 1;
    @(negedge clk) start_seq = 1;
    @(negedge clk) start_seq = 0;
    #5000 $stop();
